...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='MaskLRNet', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/home/kylin/桌面/code/mini-imagenet/images', type=str,
                        help='dataset path')
...
def main(args):
    ...
    if utils.is_main_process() and not args.eval:
        os.environ["WANDB_API_KEY"] = '9d93cd479a10d9c540ba6103a4751abba0829459' # 
    ...
    if True:  # args.distributed:
        ...
        if global_rank == 0:
            batch_size = 32  # 为 GPU 0 分配更多的内存
        else:
            batch_size = 32  # 其他 GPU 分配较小的 batch size
